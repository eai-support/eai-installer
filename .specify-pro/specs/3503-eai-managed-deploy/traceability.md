...
| --- | --- | --- |
| DTE-056, DTE-088 | manifest, bootstrap scripts, desktop executable probe, published-package release gate, and cross-platform guest capability readback | bootstrap, manifest, isolated package fixture, Rust fixture, guest adapter, and release tests |
