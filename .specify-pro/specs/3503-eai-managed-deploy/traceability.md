...
| --- | --- | --- |
| DTE-056, DTE-088 | manifest, exact option-token probes, desktop executable probe, published-package gate on every release entry point, and cross-platform guest capability readback | bootstrap, protected release workflow, isolated package fixture, Rust fixture, guest adapter, and release tests |
