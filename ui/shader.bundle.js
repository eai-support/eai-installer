(() => {
  ...
  // ui/vendor/paper-shaders/vertex-shader.js
...
void main() {
  ...
  // ui/vendor/paper-shaders/shader-mount.js
  ...
  // ui/vendor/paper-shaders/shader-sizing.js
  ...
  // ui/vendor/paper-shaders/shader-utils.js
  var declarePI = `
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/mesh-gradient.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/smoke-ring.js
  var smokeRingMeta = {
    maxColorCount: 10,
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/neuro-noise.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/dot-orbit.js
  var dotOrbitMeta = {
    maxColorCount: 10
  };
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/dot-grid.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/simplex-noise.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/metaballs.js
  var metaballsMeta = {
    maxColorCount: 8,
    maxBallsCount: 20
  };
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/perlin-noise.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/voronoi.js
  var voronoiMeta = {
    maxColorCount: 5
  };
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/waves.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/warp.js
  var warpMeta = {
    maxColorCount: 10
  };
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/god-rays.js
  var godRaysMeta = {
    maxColorCount: 5
  };
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/spiral.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/swirl.js
  var swirlMeta = {
    maxColorCount: 10
  };
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/dithering.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/grain-gradient.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/pulsing-border.js
...
void main() {
  ...
  // ui/vendor/paper-shaders/shaders/color-panels.js
  var colorPanelsMeta = {
    maxColorCount: 7
  };
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/static-mesh-gradient.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/static-radial-gradient.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/paper-texture.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/water.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/fluted-glass.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/image-dithering.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/lens-distortion.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/heatmap.js
  var heatmapMeta = {
    maxColorCount: 10
  };
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/liquid-metal.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/halftone-dots.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/halftone-cmyk.js
...
`;
  ...
  // ui/vendor/paper-shaders/shaders/gem-smoke.js
  var gemSmokeMeta = {
    maxColorCount: 6
  };
...
`;
  ...
  // ui/vendor/paper-shaders/get-shader-color-from-string.js
  ...
  // ui/vendor/paper-shaders/get-shader-noise-texture.js
  ...
  var WARP_COLORS = ["#0D3856", "#0E3755", "#0A180D"];
  var STYLES = {
    warp: {
  ...
  var DEFAULT_STYLE = "warp";
  var STORE_KEY = "eai-setup-art";
  var stage = document.getElementById("setupShader");
  var panel = document.querySelector(".setup-split-art");
