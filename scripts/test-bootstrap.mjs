...
for (const value of ["eai_version_supported", "eai_managed_deploy_ready", "major == 3 && minor == 17", "eai deploy app --help", "--source", "--github-link-session"]) {
