...
for (const value of ["eai_version_supported", "eai_managed_deploy_ready", "major == 3 && minor == 18", "eai deploy app --help", "--source", "--github-link-session"]) {
...
for (const value of ["Has-EaiManagedDeploy", "[version]::new(3, 18, 0)", "eai deploy app --help", "--source", "--github-link-session"]) {
...
for (const value of ["const MIN_EAI_CLI_VERSION: (u64, u64, u64) = (3, 18, 0)", "MIN_NODE_MAJOR_VERSION: u64 = 24", "fn node_version()", "@enterpriseai/cli", "eai_cli_version()", "fn eai_cli_is_compatible", "current_version >= MIN_EAI_CLI_VERSION", 'deploy_help.contains("--source")', 'deploy_help.contains("--github-link-session")', "run_program(\"eai\", &[\"deploy\", \"app\", \"--help\"])", "user_npm_global_exec_dirs", "fn eai_cli_script", "APPDATA", "run_program_in_directory_with_env(\"node\", &node_args, directory, environment)"] ) {
