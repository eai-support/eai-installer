...
for (const value of ["fn git_checkout_path", '"--show-toplevel"', '"--absolute-git-dir"', "fn checkout_marker_git_dir", "resolved.ancestors()", "symlink_metadata", "file_type().is_symlink()", "checkout-link", "metadata-link", "arbitrary-metadata"]) {
