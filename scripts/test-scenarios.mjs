...
const requiredIds = [
  ...
  "INIT-03", "INIT-04", "INIT-05", "INIT-06", "COMPLETE-01", "COMPLETE-02", "AI-01", "AI-02", "AI-03", "AI-04",
];

for (const id of requiredIds) {
  if (!matrix.includes(`| ${id} |`)) throw new Error(`scenario matrix is missing ${id}`);
}
if (!matrix.includes("spawn EINVAL") || !matrix.includes("button immediately changes") || !matrix.includes("Double-click")) {
